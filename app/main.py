...
from src.nexus.data.database import get_completed_predictions, get_upcoming_predictions, get_summary
...
with tab3:
    ...
    import os
    bracket_file = "data_store/databases/tournament_bracket.json"
...
with tab4:
    ...
    mc_file = "data_store/databases/monte_carlo_results.json"
